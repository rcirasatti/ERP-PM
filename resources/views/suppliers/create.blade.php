    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-md p-8">
                <h2 class="text-2xl font-bold text-gray-900 mb-6">Form Tambah Supplier Baru</h2>
                ...
                <form action="{{ route('supplier.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nama" name="nama" value="{{ old('nama') }}" placeholder="Masukkan nama supplier" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('nama') border-red-500 @enderror" required>
                        @error('nama')
            ...
            <div class="bg-blue-50 rounded-lg p-6 border border-blue-200">
                ...
                <ul class="space-y-3 text-sm text-blue-800">
                    <li class="flex space-x-2">
                        ...
                        <span><strong>Nama Supplier:</strong> Nama perusahaan supplier</span>
                    </li>
                    <li class="flex space-x-2">
                        <span class="text-blue-600 font-bold">•</span>
                        <span><strong>Email:</strong> Email resmi supplier untuk komunikasi</span>
                    </li>
                    <li class="flex space-x-2">
                        <span class="text-blue-600 font-bold">•</span>
                    ...
                    <li class="flex space-x-2">
                        <span class="text-blue-600 font-bold">•</span>
                        <span><strong>Alamat:</strong> Alamat lengkap kantor atau gudang supplier</span>
                    </li>
                </ul>
            </div>
        </div>
