...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900">Tambah Task Baru</h1>
        <p class="text-gray-600 mt-1">Project: {{ $proyek->nama }}</p>
    </div>

    <div class="max-w-2xl">
        <form action="{{ route('proyek.tugas.store', $proyek->id) }}" method="POST" class="bg-white rounded-lg shadow p-6">
            @csrf
            ...
            <div class="mb-6">
                ...
                <input type="text" name="nama" id="nama" 
                       ...
                       value="{{ old('nama') }}" placeholder="Masukkan nama task" required>
                @error('nama')
