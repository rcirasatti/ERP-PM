...
<div id="sidebar"
    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto"
        ...
        <a href="{{ route('finance.pengeluaran') }}"
            class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('finance.pengeluaran') ? 'bg-blue-600 text-white' : 'text-slate-300 hover:bg-slate-800' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
