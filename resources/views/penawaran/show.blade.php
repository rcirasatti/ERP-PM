...
@section('content')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1">
            ...
            <!-- Documents Section (Only if approved) -->
            @if($penawaran->status === 'disetujui')
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                <h2 class="text-lg font-semibold text-gray-900 mb-4">Download Dokumen</h2>
                <p class="text-sm text-gray-600 mb-4">Penawaran ini sudah disetujui. Anda dapat mengunduh dokumen berikut:</p>

                <div class="space-y-2 mb-4">
                    <p class="text-sm font-semibold text-gray-700">Invoice:</p>
                    <div class="flex flex-col space-y-2">
                        <a href="{{ route('penawaran.document.invoice-gsb', $penawaran->id) }}" target="_blank" class="px-4 py-2 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition font-medium text-sm flex items-center justify-between">
                            <span>Invoice GSB</span>
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 16v-4m0 0V8m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                        </a>
                        <a href="{{ route('penawaran.document.invoice-ritel', $penawaran->id) }}" target="_blank" class="px-4 py-2 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition font-medium text-sm flex items-center justify-between">
                            <span>Invoice Ritel</span>
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 16v-4m0 0V8m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                        </a>
                        <a href="{{ route('penawaran.document.invoice-corporate', $penawaran->id) }}" target="_blank" class="px-4 py-2 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition font-medium text-sm flex items-center justify-between">
                ...
                <div class="space-y-2">
                    <p class="text-sm font-semibold text-gray-700">Dokumen Lainnya:</p>
                    <div class="flex flex-col space-y-2">
                        <a href="{{ route('penawaran.document.surat-jalan', $penawaran->id) }}" target="_blank" class="px-4 py-2 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition font-medium text-sm flex items-center justify-between">
                            <span>Surat Jalan</span>
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 16v-4m0 0V8m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                        </a>
                        <a href="{{ route('penawaran.document.bas', $penawaran->id) }}" target="_blank" class="px-4 py-2 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition font-medium text-sm flex items-center justify-between">
                            <span>BAS (Berita Acara Survey)</span>
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 16v-4m0 0V8m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                        </a>
                        <a href="{{ route('penawaran.document.bast', $penawaran->id) }}" target="_blank" class="px-4 py-2 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition font-medium text-sm flex items-center justify-between">
                            <span>BAST (Berita Acara Serah Terima)</span>
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 16v-4m0 0V8m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                        </a>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-lg font-semibold text-gray-900 mb-4">Informasi Client</h2>                <div class="space-y-4">
                    <div>
