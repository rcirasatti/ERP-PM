...
@section('content')
    ...
    <!-- Form Section -->
    <form action="{{ route('quotations.update', $penawaran->id) }}" method="POST" id="penawaranForm">
        @csrf
        @method('PUT')
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow-md p-6 sticky top-8">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="{{ route('quotations.show', $penawaran->id) }}" class="block w-full px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition font-medium text-center">
                            Batal
                        </a>
                    </div>
                </div>
