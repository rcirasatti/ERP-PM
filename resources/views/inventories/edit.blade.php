    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-md p-8">
                <h2 class="text-2xl font-bold text-gray-900 mb-6">Edit Data Inventory</h2>
            ...
            <div class="bg-blue-50 rounded-lg p-6 border border-blue-200">
                ...
                <div class="space-y-3 text-sm text-blue-800">
                    <div>
                        ...
                        <p class="text-gray-700">{{ $inventory->id }}</p>
                    </div>
                    <div>
                        <p class="font-semibold">Material Saat Ini:</p>
                        <p class="text-gray-700">{{ $inventory->material->nama ?? 'N/A' }}</p>
                    </div>
                </div>
                
                <div class="mt-6 pt-6 border-t border-blue-200">
                    <a href="{{ route('material.index') }}" class="inline-block w-full px-4 py-2 bg-blue-600 text-white text-center rounded-lg hover:bg-blue-700 transition font-medium text-sm mb-2">
                        Lihat Daftar Material
                    </a>
                    <a href="{{ route('material.create') }}" class="inline-block w-full px-4 py-2 bg-green-600 text-white text-center rounded-lg hover:bg-green-700 transition font-medium text-sm">
                        Buat Material Baru
                    </a>
                </div>
            </div>
